...
//         Attack attack = new Attack(curvePool, lending, curveLptoken, address(player), TREASURY_LP_BALANCE, stETH, weth, address(treasury), dvt);

//         curveLptoken.transferFrom(address(treasury), address(attack), TREASURY_LP_BALANCE);
//         weth.transferFrom(address(treasury), address(attack), TREASURY_WETH_BALANCE);
